...
public class EventsController : ControllerBase
{
	...
	private readonly IEventRecurrenceService eventRecurrenceService;
	...
	)
	{
		...
		{
			model.Title = eventRecurrenceService.BuildTrainingTitle(model.StartDateTime);
		}
		...
		var eventsToCreate = eventRecurrenceService.BuildOccurrences(clubEvent, model.Recurrence);
	...
	)
	{
		...
		if (model.Type != ClubEventType.Match)
		{
			...
			return eventRecurrenceService.Validate(model.Type, model.StartDateTime, model.Recurrence);
		}
