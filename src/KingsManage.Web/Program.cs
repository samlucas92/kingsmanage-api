...
builder.Services.AddScoped<IOppositionTeamService, OppositionTeamService>();
builder.Services.AddScoped<ILeagueRuleService, LeagueRuleService>();
...
builder.Services.AddScoped<ILeagueEligibilityService, LeagueEligibilityService>();
builder.Services.AddScoped<IPlayerStatsQueryService, PlayerStatsQueryService>();
builder.Services.AddScoped<ISeasonRolloverService, SeasonRolloverService>();
builder.Services.AddScoped<IAvailabilityReportQueryService, AvailabilityReportQueryService>();
builder.Services.AddScoped<IFinanceReportQueryService, FinanceReportQueryService>();
builder.Services.AddScoped<IPlayerReportsQueryService, PlayerReportsQueryService>();
builder.Services.AddScoped<ITeamPerformanceReportQueryService, TeamPerformanceReportQueryService>();
