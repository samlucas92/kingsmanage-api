...
using MongoClubNotificationService = KingsManage.Mongo.Services.ClubNotificationService;
using MongoClubPostService = KingsManage.Mongo.Services.ClubPostService;
using MongoClubPostTemplateService = KingsManage.Mongo.Services.ClubPostTemplateService;
using MongoClubTeamService = KingsManage.Mongo.Services.ClubTeamService;
...
builder.Services.AddScoped<IClubPostTemplateService, MongoClubPostTemplateService>();
